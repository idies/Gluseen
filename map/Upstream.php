...
$query=array("dateTime"=>array('$gte'=>'2013-12-07','$lt'=>'2014-08-20'),"SITE_NO"=>$num);
...
d3.csv("data/Upstream.csv", function(error, data) {
...
d3.csv("data/P5_N.csv", function(error, data) {
