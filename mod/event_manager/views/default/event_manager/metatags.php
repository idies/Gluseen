...
<script src="<?php echo $vars['url'];?>mod/event_manager/vendors/jquery.editable.js" type="text/javascript"></script>
<script src="<?php echo $vars['url'];?>mod/event_manager/vendors/jqueryui/ui.core.min.js" type="text/javascript"></script>
<script src="<?php echo $vars['url'];?>mod/event_manager/vendors/jqueryui/ui.sortable.min.js" type="text/javascript"></script>
<?php 
...
?>
<link rel="stylesheet" href="<?php echo $vars["url"];?>mod/event_manager/vendors/fancybox/jquery.fancybox-1.3.4.css" type="text/css" />
