<?php
	...
	function event_manager_init()
	{
		...
		add_subtype('object', EventRegistration::SUBTYPE, EVENT_MANAGER_EVENTREGISTRATION_CLASSNAME);
	...
	register_action("event_manager/event/register",			false,dirname(__FILE__)."/actions/event/register.php");
